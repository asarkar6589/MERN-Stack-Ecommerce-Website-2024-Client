...
import { ShippingAddress, cartItemsType, initialCartStateType } from "../../types/initialState-types";
...
export const cartReducer = createSlice({
    ...
    reducers: {
        ...
        calculatePrice: (state) => {
            ...
            state.total = state.subtotal + state.shippingCharge + state.tax - state.discount;
        },
...
export const {addToCartFun, removeFromCart, calculatePrice, calculateDiscount, resetCart, saveShippingInfo} = cartReducer.actions;
